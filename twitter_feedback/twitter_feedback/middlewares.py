...
from .settings import REDIS_HOST, REDIS_PARAMS, REDIS_PORT
from oauthlib.oauth1 import Client as Oauth1Client
import requests


class TwitterFeedbackSpiderMiddleware(object):
...
class TwitterFeedbackDownloaderMiddleware(object):
    # Not all methods need to be defined. If a method is not defined,
...
class SpiderMiddleware(object):
    def __init__(self):
        """爬虫监控"""
        self.WEBHOOK = "https://oapi.dingtalk.com/robot/send?access_token=xxxxxxx"
        self.Ding_Bot = DingtalkChatbot(self.WEBHOOK)
        self.db = redis.StrictRedis(host=REDIS_HOST, port=REDIS_PORT, db=9, password=REDIS_PARAMS["password"])
